...
var Context = _react["default"].createContext ? /*#__PURE__*/_react["default"].createContext({
  dfpNetworkId: null,
  dfpAdUnit: null,
  dfpSizeMapping: null,
  ...
  _createClass(DFPSlotsProvider, [{
    ...
    value: function getContextValue() {
      var _this$props = this.props,
        ...
        ctxDfpTargetingArguments = _this$contextValue.targetingArguments;
    ...
    value: function shouldReloadConfig(nextProps) {
      ...
      if (this.props.autoLoad || nextProps.autoLoad) {
        if (_typeof(reloadConfig) === 'object') {
          var attrs = Object.keys(reloadConfig);
          // eslint-disable-next-line guard-for-in, no-restricted-syntax
          for (var i in attrs) {
            var propName = attrs[i];
